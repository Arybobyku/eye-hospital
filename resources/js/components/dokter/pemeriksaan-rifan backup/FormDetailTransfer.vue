...
import { parsetransfertindakan } from './Attachment.js';
...
export default {
	...
	methods: {
		...
		parsetransfertindakan, formkelurahan, initindexdb, indexdbprocessing, arrpemeriksaan, datename,
		...
		parsingForm:function() {
			vm.$emit('parsingForm', vm.parsetransfertindakan(vm.form, vm.detail, vm.listdata), 'adddatatransfer'); 
		},
      ...
      vm.$emit('dialog', text, button, 'formdetailtransfer');
    },
