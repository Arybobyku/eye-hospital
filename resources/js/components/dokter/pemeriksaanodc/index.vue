...
export default {
	...
	data: function () { return {
		...
		attach: {
			link : {
				list: '/dokter/pemeriksaanodc/list',
				add: '/dokter/pemeriksaanodc/add',
				adddatatransfer: '/dokter/pemeriksaanodc/adddatatransfer',
				detail: '/dokter/pemeriksaanodc/detail',
				detailtransfer: '/dokter/pemeriksaanodc/detailtransfer',
				cetakan: '/dokter/pemeriksaanodc/cetakan',
				suratistirahat: '/dokter/pemeriksaanodc/suratistirahat',
				suratkonsul: '/dokter/pemeriksaanodc/suratkonsul',
				suratbalasankonsul: '/dokter/pemeriksaanodc/suratbalasankonsul',
				resepkacamata: '/dokter/pemeriksaanodc/resepkacamata',
				histori: '/rawatjalan/pemeriksaan/histori',
				historidokter: '/dokter/pemeriksaan/histori',
				call: '/dokter/pemeriksaanodc/call',
				listpending: '/dokter/pemeriksaanodc/listpending',
				listtriase: '/dokter/pemeriksaanodc/listtriase',
				listtransfer: '/dokter/pemeriksaanodc/listtransfer',
