...
export const formkelurahan = () => {
	return {
		...
		keteranganbedahr:{
			title: 'Keterangan Bedah', for_id: 'form_'+'keteranganbedahr', type: 'text', required: '', 
			name: 'keteranganbedahr', value: '', disabled: false, show: true, kinds: ''
		},
		...
		keteranganinap:{
			...
			name: 'keteranganinap', value: '', disabled: false, show: true, kinds: '', baris: '10'
		},
