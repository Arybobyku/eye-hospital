      ...
      vm.$emit('dialog', text, button, 'removetransfer');
		...
		setdataform: function (response) {
			...
			if (response.data.data) {
				if (response.data.data.transfer_nama_dokter != '-' && response.data.data.transfer_nama_dokter != '') {
					vm.form.select.dokter.value = response.data.data.transfer_pengguna_uuid;
					vm.form.select.dokter.label = response.data.data.transfer_nama_dokter;
				}
			}
