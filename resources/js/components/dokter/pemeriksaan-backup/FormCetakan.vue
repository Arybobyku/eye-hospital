								...
								<div class="grid">
									...
									<div class="col-1 form-ml">
										<button class="tooltip btn-success" v-on:click="action('suratistirahat')" style="margin-top: 20px">
											...
											<span class="tooltiptext">Cetak Surat Keterangan Sakit</span>
										</button>
									</div>
									<div class="col-12">
							...
							<div style="position: relative;" class="content-tab-in" v-if="tab.content.resep">
								<div class="grid">
									<div class="col-11">
										...
										<h4>Mohon</h4>
										<input class="checkbox" type="checkbox" value="m1" style="margin-bottom: 10px; cursor: pointer;"> Ulangi pemeriksaan refraksi untuk mendapatkan tajam penglihatan terbaik dan ternyaman <br />
										<input class="checkbox" type="checkbox" value="m2" style="margin-bottom: 10px; cursor: pointer;"> Resepkan kacamata sesuai dengan refraksi
										<h4>Resep buat/Prescription</h4>
										<input class="checkbox" type="checkbox" value="r1" style="margin-bottom: 10px; cursor: pointer;"> Monofocal<br />
										<input class="checkbox" type="checkbox" value="r2" style="margin-bottom: 10px; cursor: pointer;"> Bifocal/Progressive<br />
										<input class="checkbox" type="checkbox" value="r3" style="margin-bottom: 10px; cursor: pointer;"> Contact Lens<br />
										<input class="checkbox" type="checkbox" value="r4" style="margin-bottom: 10px; cursor: pointer;"> Transitional
									</div>
									<div class="col-1 form-ml">
										<button class="tooltip btn-success" v-on:click="action('resepkacamata')" style="margin-top: 20px">
											<vue-feather type="printer"></vue-feather> 
											<span class="tooltiptext">Cetak Resep Kacamata</span>
										</button>
									</div>
								</div>
							</div>
								...
								<div class="grid">
									...
									<div class="col-1 form-ml">
										<button class="tooltip btn-success" v-on:click="action('suratkonsul')" style="margin-top: 20px">
											<vue-feather type="printer"></vue-feather> 
											<span class="tooltiptext">Cetak Surat Konsul</span>
										</button>
									</div>
									<div class="col-12">
								...
								<div class="grid">
									...
									<div class="col-1 form-ml">
										<button class="tooltip btn-success" v-on:click="action('suratbalasankonsul')" style="margin-top: 20px">
											<vue-feather type="printer"></vue-feather> 
											<span class="tooltiptext">Cetak Surat Balasan Konsul</span>
										</button>
									</div>
									<div class="col-12">
