export const parsekelurahan = (form, detail, tindakan, obat, obatracikan) => {
	...
	data.append('keterangan', form.keteranganbedahr.value);
	...
	data.append('keterangan_bedah_bedah', form.keteranganbedahbedah.value);
