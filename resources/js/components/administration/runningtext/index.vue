...
export default {
	...
	data: function () { return {
		...
		attach: {
			link : {
				list: '/administration/runningtext/list',
				add: '/administration/runningtext/add',
				edit: '/administration/runningtext/edit',
				update: '/administration/runningtext/update',
				block: '/administration/runningtext/block',
				active: '/administration/runningtext/active',
			}, url: '', data: null
		},
		column: [
			{ value: 'content', label: 'Isi dari Running Text', type: 'text', search: true, close: false, button: false },
		...
		*************************************************************************************************************************/
		...
		btnhtml:function(_item, _index) {
			let str = [
				...
				{ 
					icon: 'x-circle', color: 'btn-danger', posisi: 'block', tooltip: 'Block Data', item: _item, index: _index, 
					show: _item.status == 'active' ? true : false },
				{ 
					icon: 'check-circle', color: 'btn-success', posisi: 'active', tooltip: 'Active Data', item: _item, index: _index, 
					show: _item.status == 'block' ? true : false }
			]
			return str;
		},
		...
		tablebutton:function(posisi, data, index) {
			if (posisi == 'add') {
				...
				vm.dialog('Yakin ingin memblokir data yang terpilih dihalaman ini.', 'Ya, blokir data', 'blockdata');
			}
				...
				vm.dialog('Yakin ingin aktifkan data yang terpilih dihalaman ini.', 'Ya, aktifkan data', 'activedata');
			}
		},
