...
export default {
	...
	methods: {
		...
		parsekelurahan, formkelurahan, initindexdb, indexdbprocessing,
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parsekelurahan(vm.form), 'kelurahan'); },
		...
		setdataform: function (response) {
			...
			vm.form.select.kecamatan.value = response.data.data.kecamatan_id;
			vm.form.select.kecamatan.label = response.data.data.nama_kecamatan;
			vm.loaderprocess();
		},
      ...
      vm.$emit('dialog', text, button, 'formkelurahan');
    },
	}
}
</script>