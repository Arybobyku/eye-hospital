...
export const formkelurahan = () => {
	return {
		...
		noinvoice:{
			title: 'No Invoice', for_id: 'form_'+'noinvoice', type: 'text', required: '', 
			name: 'noinvoice', value: '', disabled: false, show: true, kinds: ''
		},

		nopendaftaran:{
			title: 'No Pendaftaran', for_id: 'form_'+'nopendaftaran', type: 'text', required: '', 
			name: 'nopendaftaran', value: '', disabled: false, show: true, kinds: ''
		},

		waktupendaftaran:{
			title: 'Waktu Pendaftaran', for_id: 'form_'+'waktupendaftaran', type: 'text', required: '', 
			name: 'waktupendaftaran', value: '', disabled: false, show: true, kinds: ''
		},

		tanggalpendaftaran:{
			title: 'Tanggal Pendaftaran', for_id: 'form_'+'tanggalpendaftaran', type: 'date', required: '', 
			name: 'tanggalpendaftaran', value: '', disabled: false, show: true, kinds: ''
		},

		tanggalcetak:{
			title: 'Tanggal Cetak', for_id: 'form_'+'tanggalcetak', type: 'date', required: '', 
			name: 'tanggalcetak', value: '', disabled: false, show: true, kinds: ''
		},

		tanggalselesai:{
			title: 'Tanggal Selesai', for_id: 'form_'+'tanggalselesai', type: 'date', required: '', 
			name: 'tanggalselesai', value: '', disabled: false, show: true, kinds: ''
		},

		waktuselesai:{
			title: 'Waktu Selesai', for_id: 'form_'+'waktuselesai', type: 'text', required: '', 
			name: 'waktuselesai', value: '', disabled: false, show: true, kinds: ''
		},
