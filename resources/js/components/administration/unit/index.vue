...
export default {
	...
	data: function () { return {
		...
		attach: {
			link : {
				list: '/administration/unit/list',
				add: '/administration/unit/add',
				edit: '/administration/unit/edit',
				update: '/administration/unit/update',
				remove: '/administration/unit/remove',
			}, url: '', data: null
		},
		column: [
			{ value: 'nama', label: 'Nama Unit', type: 'text', search: true, close: false, button: false },
