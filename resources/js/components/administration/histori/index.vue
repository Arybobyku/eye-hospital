...
export default {
	...
	components: { toast, Datatable: defineAsyncComponent(() => import('../../../section/Datatable.vue')) },
	created: function () {},
	mounted: function () {
		vm = this;
	...
	data: function () { return {
		uri: 'histori',
		position: '',
		attach: { link : { list: '/administration/histori/list' }, url: '', data: null },
		column: [
			{ value: 'created_at', label: 'Tanggal', type: 'text', search: false, close: false, button: false },
			{ value: 'nama', label: 'Nama Pegawai', type: 'text', search: false, close: false, button: false },
