...
import { formprovinsi } from './FormData.js';
import { parseprovinsi } from './Attachment.js';
var vm, body;
export default {
	...
	methods: {
		...
		aturulang: function () { vm.form = vm.formprovinsi(); },
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parseprovinsi(vm.form), 'provinsi'); },
      ...
      vm.$emit('dialog', text, button, 'formprovinsi');
    },
	}
}
</script>