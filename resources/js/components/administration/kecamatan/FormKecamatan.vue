...
import { formkecamatan } from './FormData.js';
import { parsekecamatan } from './Attachment.js';
...
export default {
	...
	methods: {
		...
		parsekecamatan, formkecamatan, initindexdb, indexdbprocessing,
		...
		aturulang: function () { vm.form = vm.formkecamatan(); },
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parsekecamatan(vm.form), 'kecamatan'); },
		...
		setdataform: function (response) {
			...
			vm.form.select.kabkota.value = response.data.data.kab_kota_id;
			vm.form.select.kabkota.label = response.data.data.nama_kab_kota;
			vm.loaderprocess();
		},
      ...
      vm.$emit('dialog', text, button, 'formkecamatan');
    },
	}
}
</script>