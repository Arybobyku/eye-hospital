export const formpengguna = () => {
	return {
		...
		mulaibekerja: { 
			title: 'Mulai Bekerja', for_id: 'form_'+'mulaibekerja', type: 'date', required: 'required', 
			name: 'mulaibekerja', value: '', disabled: false, show: true, kinds: ''
		},
		sebagai: { 
		...
		usernamepengguna: { 
			title: 'Username', for_id: 'form_'+'usernamepengguna', type: 'text', required: 'required', 
			name: 'usernamepengguna', value: '', disabled: false, show: true, kinds: ''
		},
		namapengguna: { 
		...
		nobpjsketenagakerjaan: { 
			title: 'No. Kartu', for_id: 'form_'+'nobpjasketenagakerjaan', type: 'text', required: '', 
			name: 'nobpjasketenagakerjaan', value: '', disabled: false, show: true, kinds: ''
		},
		daruratnama: { 
		...
		select: {
			posisiakun: { 
				key : 'posisiakun', for_id: 'form_'+'posisiakun', name: 'posisiakun', uuid:'', value: '', label: 'Silahkan Pilih', 
				filter: [], data: [], search: '', option: 'display: none', statics: true,
				class: 'posisiakun', isrequired: true, html: 'Posisi Akun', issearch: false, disabled: false,
			},
			jeniskelamin: { 
			...
			bpjsketenagakerjaan: { 
				key : 'bpjsketenagakerjaan', for_id: 'form_'+'bpjsketenagakerjaan', name: 'bpjsketenagakerjaan', uuid:'', value: '', label: 'Silahkan Pilih', 
				filter: [], data: [], search: '', option: 'display: none', statics: true,
				class: 'bpjsketenagakerjaan', isrequired: true, html: 'Status BPJS Ketenagakerjaan', issearch: false, disabled: false,
			},
		}
	}
}
