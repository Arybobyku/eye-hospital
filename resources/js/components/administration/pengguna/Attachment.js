export const parsepengguna = (form) => {
	...
	data.append('posisi_pengguna', form.select.posisiakun.value);
	data.append('mulai_bekerja', form.mulaibekerja.value);
	data.append('username_pengguna', form.usernamepengguna.value);
	...
	data.append('bpjs_ketenagakerjaan', form.select.bpjsketenagakerjaan.value);
	data.append('no_bpjs_ketenagakerjaan', form.nobpjsketenagakerjaan.value);
