...
import { formjeniskamar } from './FormData.js';
import { parsejeniskamar } from './Attachment.js';
var vm, body;
export default {
	...
	methods: {
		...
		parsejeniskamar, formjeniskamar,
		...
		aturulang: function () { vm.form = vm.formjeniskamar(); },
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parsejeniskamar(vm.form), 'jeniskamar'); },
      ...
      vm.$emit('dialog', text, button, 'formjeniskamar');
    },
	}
}
</script>