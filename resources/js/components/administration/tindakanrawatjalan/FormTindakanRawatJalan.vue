...
import { formtindakanrawatjalan } from './FormData.js';
import { parsetindakanrawatjalan } from './Attachment.js';
var vm, body;
export default {
	...
	mounted:function() { 
		...
		vm.form = vm.formtindakanrawatjalan();
	},
	created:function() {},
	...
	methods: {
		...
		parsetindakanrawatjalan, formtindakanrawatjalan,
		...
		aturulang: function () { vm.form = vm.formtindakanrawatjalan(); },
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parsetindakanrawatjalan(vm.form), 'tindakanrawatjalan'); },
      ...
      vm.$emit('dialog', text, button, 'formtindakanrawatjalan');
    },
	}
}
</script>