...
import { formicd10 } from './FormData.js';
import { parseicd10 } from './Attachment.js';
var vm, body;
export default {
	...
	methods: {
		...
		aturulang: function () { vm.form = vm.formicd10(); },
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parseicd10(vm.form), 'icd10'); },
      ...
      vm.$emit('dialog', text, button, 'formicd10');
    },
	}
}
</script>