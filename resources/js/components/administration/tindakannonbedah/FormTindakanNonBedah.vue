...
import { formtindakannonbedah } from './FormData.js';
import { parsetindakannonbedah } from './Attachment.js';
var vm, body;
export default {
	...
	mounted:function() { 
		...
		vm.form = vm.formtindakannonbedah();
	},
	created:function() {},
	...
	methods: {
		...
		parsetindakannonbedah, formtindakannonbedah,
		...
		aturulang: function () { vm.form = vm.formtindakannonbedah(); },
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parsetindakannonbedah(vm.form), 'tindakannonbedah'); },
      ...
      vm.$emit('dialog', text, button, 'formtindakannonbedah');
    },
	}
}
</script>