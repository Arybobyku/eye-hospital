...
import { formkabkota } from './FormData.js';
import { parsekabkota } from './Attachment.js';
...
export default {
	...
	methods: {
		...
		parsekabkota, formkabkota, initindexdb, indexdbprocessing,
		...
		aturulang: function () { vm.form = vm.formkabkota(); },
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parsekabkota(vm.form), 'kabkota'); },
		...
		setdataform: function (response) {
			...
			vm.form.select.provinsi.value = response.data.data.provinsi_id;
			vm.form.select.provinsi.label = response.data.data.nama_provinsi;
			vm.loaderprocess();
		},
      ...
      vm.$emit('dialog', text, button, 'formkabkota');
    },
	}
}
</script>