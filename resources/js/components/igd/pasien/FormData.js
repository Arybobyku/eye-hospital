export const formpasien = () => {
	return {
		...
		alamat: { 
			title: 'Alamat', for_id: 'form_'+'alamat', type: 'text', required: '', 
			name: 'alamat', value: '', disabled: false, show: true, kinds: ''
		},
		nohandphone: { 
			title: 'No Handphone', for_id: 'form_'+'nohandphone', type: 'text', required: '', 
		...
		select: {
			provinsi: { 
				...
				class: 'provinsi', isrequired: false, html: 'Nama Provinsi', issearch: true, disabled: false,
			},
			kabkota: { 
				key : 'kabkota', for_id: 'form_'+'kabkota', name: 'kabkota', uuid:'', value: '', label: 'Silahkan Pilih', 
				filter: [], data: [], search: '', option: 'display: none', statics: false,
				class: 'kabkota', isrequired: false, html: 'Nama Kabupaten/Kota', issearch: true, disabled: false,
			},
			kecamatan: { 
				key : 'kecamatan', for_id: 'form_'+'kecamatan', name: 'kecamatan', uuid:'', value: '', label: 'Silahkan Pilih', 
				filter: [], data: [], search: '', option: 'display: none', statics: false,
				class: 'kecamatan', isrequired: false, html: 'Nama Kecamatan', issearch: true, disabled: false,
			},
			kelurahan: { 
			...
			agama: { 
				...
				filter: [], data: [], search: '', option: 'display: none', statics: true,
				class: 'agama', isrequired: false, html: 'Agama', issearch: false, disabled: false,
			},
			jeniskelamin: { 
	...
	return {
		...
		select: {
			...
			dokterumum: { 
				...
				filter: [], data: [], search: '', option: 'display: none', statics: false,
				class: 'dokterumum', isrequired: true, html: 'Dokter (Umum) yang menangani', issearch: false, disabled: false,
			},
