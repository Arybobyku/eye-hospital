	...
	<div class="grid" v-if="form">
		<div class="col-7">
			<div class="inner wrap-laporan" ref="roottable">
				<div class="grid">
					<div class="col-12">
						<h3 style="text-decoration: underline;">Laporan Kontrol Pasien</h3>
					</div>
					<div class="col-6">
	...
	methods: {
		...
		excel:function(posisi) {
			...
			if (posisi == 'tindakan') {
				...
				uri = '/laporan/excel/kontrol/' + vm.form.dari.value + '/' + vm.form.ke.value + '/' + carabayar_uuid + '/' + asuransi_uuid + '/' + dokter_uuid + '/' + layanan_uuid;
			}
