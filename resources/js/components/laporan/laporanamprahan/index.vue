...
export default {
	...
	data: function () { return {
		...
		position: '',
		form: null,
		attach: { link : { list: '/laporan/amprahan' }, url: '', data: null },
		column: [
			{ value: 'tanggal', label: 'Tanggal', type: 'text', search: false, close: false, button: false },
			{ value: 'waktu', label: 'Pukul', type: 'text', search: false, close: false, button: false },
			{ value: 'nama_pasien', label: 'Nama Pasien', type: 'text', search: false, close: false, button: false },
			{ value: 'nama_obat', label: 'Nama obat', type: 'text', search: false, close: false, button: false },
			{ value: 'jumlah_kecil', label: 'Jumlah', type: 'text', search: false, close: false, button: false },
			{ value: 'nama_satuan_kecil', label: 'Satuan', type: 'text', search: false, close: false, button: false },
			{ value: 'hja_resep', label: 'HJA Resep', type: 'text', search: false, close: false, button: false },
