				...
				<div class="grid">
					<div class="col-3 form-mr" v-if="!isapproval">
						<div class="grid">
							...
							<div class="col-12">
								<Inputed :ref="form.jumlah.name" :form="form.jumlah" v-on:keyup="checkup($event)"></Inputed>
							</div>
		...
		add:function() {
			...
			if (next) {
				let tmp = {
					...
					dari_unit_id: '4',
					dari_unit_uuid: 'd88a34c8-f377-4477-88bc-643a8e0e041b',
					dari_nama_unit: 'Apotek',
				}
