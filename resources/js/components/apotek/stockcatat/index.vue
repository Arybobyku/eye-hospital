	...
	data: function () { return {
		...
		attach: {
			link : {
				...
				add: '/apotek/stockcatatlabel/add',
				edit: '/apotek/stockcatatlabel/edit',
				update: '/apotek/stockcatatlabel/update',
				remove: '/apotek/stockcatatlabel/remove',
				getbalance: '/apotek/stockcatatlabel/getbalance',
				addbalance: '/apotek/stockcatatlabel/addbalance',
				prosesbalance: '/apotek/stockcatatlabel/prosesbalance',
