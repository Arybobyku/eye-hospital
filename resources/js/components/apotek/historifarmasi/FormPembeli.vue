		...
		<div ref="rootmodal" class="modal-content modal-sedang" :class="terminate.show ? 'modal-opened' : 'modal-closed'">
			...
			<div class="modal-body" v-if="form">
				<div class="grid">
					...
					<div class="col-12">
						<Inputed :ref="form.jenis.name" :form="form.jenis"></Inputed>
					</div>
				</div>
			</div>
...
import { formpembeli } from './FormData.js';
import { parsepembeli } from './Attachment.js';
var vm, body;
export default {
	...
	methods: {
		...
		aturulang: function () { vm.form = vm.formpembeli(); },
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parsepembeli(vm.form), 'pembeli'); },
