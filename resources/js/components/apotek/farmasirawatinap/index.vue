...
export default {
	...
	data: function () { return {
		...
		attach: {
			link : {
				list: '/apotek/farmasirawatinap/list',
				listbayar: '/apotek/farmasirawatinap/listbayar',
				editobat: '/apotek/farmasirawatinap/editobat',
				call: '/apotek/farmasirawatinap/call',
				approvement: '/apotek/farmasirawatinap/approvement',
				detail: '/apotek/farmasirawatinap/detail',
				bayar: '/apotek/farmasirawatinap/bayar',
				terima: '/apotek/farmasirawatinap/terima',
				kasir: '/print/farmasirawatinap/',
