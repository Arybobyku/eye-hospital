...
<div class="inner" ref="roottable">
  ...
  <h2 class="error-subtitle" v-if="link != 'empty'">
		would you like to try refreshing the page again? <button v-on:click="reloaded()">Reload Page</button>
  </h2>
...
export default { 
	...
	methods: { 
		reloaded:function() { this.$router.push('/dashboard/' + this.link); },
