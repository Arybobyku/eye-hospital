...
export default {
	...
	data: function () { return {
		...
		attach: {
			link : {
				list: '/asuransi/activeinapbedah/list',
				add: '/asuransi/activeinapbedah/add',
				edit: '/asuransi/activeinapbedah/edit',
				update: '/asuransi/activeinapbedah/update',
				disetujui: '/asuransi/activeinapbedah/disetujui',
			}, url: '', data: null
		},
		column: [
	...
	methods: {
		...
		*************************************************************************************************************************/
		...
		metodebayar:function(data) {
			...
			if (data.nama_asuransi != '') { msg += ' - ' + data.nama_asuransi; }
			return msg;
		},
