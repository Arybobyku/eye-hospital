...
export default {
	...
	data: function () { return {
		...
		attach: {
			link : {
				list: '/asuransi/onedaycare/list',
				add: '/asuransi/onedaycare/add',
				edit: '/asuransi/onedaycare/edit',
				update: '/asuransi/onedaycare/update',
				approve: '/asuransi/onedaycare/approve',
				deny: '/asuransi/onedaycare/deny',
				diterima: '/asuransi/onedaycare/diterima',
				dikirim: '/asuransi/onedaycare/dikirim',
				detail: '/asuransi/onedaycare/detail',
			}, url: '', data: null
		},
		column: [
			...
			{ value: 'carabayar_nama', label: 'Penjamin', type: 'text', search: true, close: false, button: false },
		...
		*************************************************************************************************************************/
		...
		tablebutton:function(posisi, data, index) {
			if (posisi == 'proses') {
				...
				vm.dialog('Yakin ingin merubah status data menjadi dikirim.', 'Ya, ubah status', 'kirimdata');
			}
