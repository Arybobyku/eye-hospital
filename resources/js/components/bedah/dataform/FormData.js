export const formlaporanpembedahan = () => {
	return {
		uuid: '',
		bedah_uuid: '', ja_umum: '', ja_bsp: '', ja_csp: '', ja_epidural: '', ja_lokal: '', ja_spiral: '', penggunaanamhpkhusus: '', komplikasi_intra_operasi: '',
		ruangoperasi: {
...
export const formpencegahanpasienjatuh = () => {
	return {
		uuid: '',
		bedah_uuid: '',
		rjr1: '',
		...
		rjt10: '',
		tanggal_pelaksanaan: {
			title: 'Tanggal Pelaksanaan', for_id: 'form_' + 'tanggal_pelaksanaan', type: 'date', required: '',
			name: 'tanggal_pelaksanaan', value: '', disabled: false, show: true, kinds: ''
		},
	}
}
