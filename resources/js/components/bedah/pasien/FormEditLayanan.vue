...
import { formeditlayanan } from './FormData.js';
import { parseeditlayanan } from './Attachment.js';
...
export default {
	...
	methods: {
		...
		parseeditlayanan, formeditlayanan, formatrupiah, datename,
		...
		parsingForm:function() { 
			...
			vm.$emit('parsingForm', vm.parseeditlayanan(vm.form, vm.listdata), 'updatelayanan'); 
		},
      ...
      vm.$emit('dialog', text, button, 'formeditlayanan');
    },
	}
}
</script>
