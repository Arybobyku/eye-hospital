...
export default {
	...
	methods: {
		...
		setdataform: function (response) {
			...
			console.log(response.data.data, 'fdfdfd');
			vm.form.jenis = response.data.data.jenis;
			vm.form.carabayar_uuid = response.data.data.carabayar_uuid;
			vm.form.carabayar_nama = response.data.data.carabayar_nama;
