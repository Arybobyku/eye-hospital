        ...
        <div class="procedure-steps">
          ...
          <div class="step-item">
            ...
            <span class="step-text"
              >Anastesi dengan injeksi lidocain subconjungtiva margin palpebra</span
            >
          </div>
          ...
          <div class="step-item">
            ...
            <span class="step-text"
              >Dengan menggunakan mesh dilakukan perlukaan di area chalazion, maka akan
              tampak keluar nanah</span
            >
          </div>
          ...
          <div class="step-item">
            ...
            <span class="step-text"
              >Beri salep antibiotik kemudian ditutup dengan kassa steril</span
            >
          </div>
  ...
  methods: {
    async fetchTahunAkreditasi() {
      try {
        ...
        if (!this.form.no_surat) {
          this.form.no_surat = `RM 9.9/LEC/${tahun}`;
        }
        ...
        if (!this.form.no_surat) {
          this.form.no_surat = 'RM 9.9/LEC/22';
        }
      }
    },
    setDataForm() {
    ...
    async submitForm() {
      ...
      try {
        ...
        const response = await axios.post("/master/pasien/dokumen-eksisi-chalazion", fd, {
