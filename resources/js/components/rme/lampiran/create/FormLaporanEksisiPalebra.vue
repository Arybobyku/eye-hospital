  ...
  <div class="container py-4">
    <div class="form-wrapper position-relative">
      ...
      <div class="text-center mb-4">
        ...
        <h3 class="fw-bold mt-4 mb-4">LAPORAN EKSISI PALPEBRA</h3>
      ...
      <div class="box-rme mb-4">
        ...
        <div class="row mb-3">
          <div class="col-md-12">
            <label>1. Diagnosa Pre Bedah : <span class="text-danger">*</span></label>
            <textarea
              v-model="form.diagnosa_pre_bedah"
              class="form-control"
              rows="3"
              placeholder="Contoh: Chalazion palpebra superior OD, Tumor palpebra, dll"
            ></textarea>
          </div>
        </div>
        ...
        <div class="row mb-3">
          <div class="col-md-12">
            ...
            <textarea
              ...
              class="form-control"
              rows="3"
              placeholder="Contoh: Eksisi tumor palpebra, Insisi chalazion, dll"
            ></textarea>
          </div>
        </div>
        ...
        <div class="row mb-3">
          <div class="col-md-12">
            ...
            <input
              ...
              class="form-control"
              placeholder="Contoh: Ruang Operasi Minor, OK Palpebra, dll"
            />
          </div>
        </div>
      </div>

      <!-- ================= PROSEDUR OPERASI (12 LANGKAH) ================= -->
      <div class="box-rme mb-4">
        ...
        <div class="procedure-steps">
          ...
          <div class="step-item">
            ...
            <span class="step-text"
              >Anastesi dengan inj. Lidocain subkutan di area lesi</span
            >
          </div>
          ...
          <div class="step-item">
            ...
            <span class="step-text"
              >Incisi daerah tumor, eksplorasi tumor tampak masa diameter ±1 cm dengan
              konsistensi kenyal, undermine subkutis</span
            >
          </div>

          <div class="step-item">
            <span class="step-number">6.</span>
            <span class="step-text">Atasi perdarahan dengan kasa steril</span>
          </div>

          <div class="step-item">
            <span class="step-number">7.</span>
            <span class="step-text">Lepaskan tumor dengan gunting</span>
          </div>

          <div class="step-item">
            <span class="step-number">8.</span>
            <span class="step-text">Evaluasi area bebas tumor dan perdarahan</span>
          </div>

          <div class="step-item">
            <span class="step-number">9.</span>
            <span class="step-text"
              >Hecting subkutis dengan vicryl 6.0 3x, lanjutkan hecting kutis 5x</span
            >
          </div>

          <div class="step-item">
            <span class="step-number">10.</span>
            <span class="step-text">Beri Genta eye salep</span>
          </div>

          <div class="step-item">
            <span class="step-number">11.</span>
            <span class="step-text">Tutup kasa steril</span>
          </div>
...
export default {
  name: "DokumenLaporanEksisiPalpebra",
  ...
  data() {
    return {
      ...
      form: {
        ...
        // Data Bedah (7 fields sesuai requirement)
        diagnosa_pre_bedah: "",
        tindakan: "",
        diagnosa_post_bedah: "",
        unit_pembedahan: "",
  ...
  methods: {
    async fetchTahunAkreditasi() {
      try {
        ...
        if (!this.form.no_surat) {
          this.form.no_surat = `RM 9.3/LEP/${tahun}`;
        }
        ...
        if (!this.form.no_surat) {
          this.form.no_surat = 'RM 9.3/LEP/22';
        }
      }
    },
    setDataForm() {
      ...
      try {
        ...
        if (typeof this.editData === "string") {
          const response = await axios.get(
            `/master/pasien/dokumen-eksisi-palpebra/${this.editData}`
          );
    ...
    async submitForm() {
      // Validasi
      if (!this.form.diagnosa_pre_bedah) {
        alert("Mohon lengkapi Diagnosa Pre Bedah!");
        return;
      }
      ...
      try {
        ...
        const response = await axios.post("/master/pasien/dokumen-eksisi-palpebra", fd, {
        ...
        const message = this.isEditMode
          ? "Laporan Eksisi Palpebra berhasil diupdate!"
          : "Laporan Eksisi Palpebra berhasil disimpan!";
