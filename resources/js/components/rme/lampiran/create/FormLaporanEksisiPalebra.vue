    ...
    <div class="box-rme mb-4">
      ...
      <div class="procedure-steps">
        ...
        <div class="step-item">
          ...
          <span class="step-text">Anastesi dengan inj. Lidocain subkutan di area lesi</span>
        </div>
        
        <div class="step-item">
          <span class="step-number">5.</span>
          <span class="step-text">Incisi daerah tumor, eksplorasi tumor tampak masa diameter ±1 cm dengan konsistensi kenyal, undermine subkutis</span>
        </div>
        ...
        <div class="step-item">
          ...
          <span class="step-text">Hecting subkutis dengan vicryl 6.0 3x, lanjutkan hecting kutis 5x</span>
        </div>
    ...
    async submitForm() {
      ...
      try {
        ...
        const response = await axios.post(
          "/master/pasien/dokumen-eksisi-palpebra",
          fd,
