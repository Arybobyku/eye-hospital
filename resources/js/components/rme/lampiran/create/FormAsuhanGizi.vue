        ...
        <div class="signature-section">
          ...
          <div class="sign-box">
            ...
            >
              ...
              <p v-if="form.ahli_gizi_ttd_timestamp" class="timestamp-ttd">
                Ditandatangani: {{ form.ahli_gizi_ttd_timestamp }}
              </p>
...
export default {
  ...
  methods: {
    ...
    clearSignature(refName) {
      ...
      if (refName === 'ttd_ahli_gizi') this.form.ahli_gizi_ttd_timestamp = "";
    ...
    saveSign(refName) {
      ...
      if (refName === 'ttd_ahli_gizi') this.form.ahli_gizi_ttd_timestamp = timestamp
