        ...
        <div class="signature-section">
          ...
          <div class="sign-box">
            ...
            >
              ...
              <p v-if="form.pembuat_ttd_timestamp" class="timestamp-ttd">
                Ditandatangani: {{ form.pembuat_ttd_timestamp }}
              </p>
...
export default {
  ...
  methods: {
    ...
    setDataForm() {
      ...
      this.form.pasien_nik = this.selectedPatient?.no_identitas || "";
    },
    ...
    clearSignature(refName) {
      ...
      if (refName === 'ttd_pembuat') this.form.pembuat_ttd_timestamp = "";
    ...
    saveSign(refName) {
      ...
      if (refName === 'ttd_pembuat') this.form.pembuat_ttd_timestamp = timestamp
