...
export default {
	...
	data: function () {
		return {
			...
			column: [
				{ value: 'tanggal', label: 'Kelas', type: 'text', search: true, close: false, button: false },
				// { value: 'waktu', label: 'Waktu', type: 'text', search: true, close: false, button: false },
				{ value: 'rekam_medis', label: 'Kode Ruang', type: 'text', search: true, close: false, button: false },
				{ value: 'nama_pasien', label: 'Nama Ruang', type: 'text', search: true, close: false, button: false },
				{ value: 'nama_dokter', label: 'Kapasitas Tempat Tidur', type: 'text', search: true, close: false, button: false },
				{ value: 'nama_dokter_bedah', label: 'Tersedia', type: 'text', search: false, close: false, button: false },
				{ value: 'nama_paket_bedah', label: 'Tersedia Pria', type: 'text', search: true, close: false, button: false },
				{ value: 'nama_paket_bedah', label: 'Tersedia Wanita', type: 'text', search: true, close: false, button: false },
				{ value: 'bedah_status', label: 'Status', type: 'text', search: false, close: false, button: false },
				{ value: 'bedah_status', label: 'Update Terakhir', type: 'text', search: false, close: false, button: false },
