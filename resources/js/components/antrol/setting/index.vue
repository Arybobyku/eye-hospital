            ...
            <div class="col-10" style="margin-left: 25%;">
                <table style="text-align: right;">
                    <tr>
                        ...
                        <br>
                        <td>
                            <input type="text" class="rounded-input" placeholder="Masukkan URL di sini">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <label class="ios-switch" style="margin-left: 100%;">
                ...
                <button class="save-button" @click="confirmSave">Save</button>
                </div>
...
export default {
    ...
    methods: {
        handleClick() {
            alert("Tombol aktif di-klik!");
        },
        confirmSave() {
      let text = 'Apakah anda yakin ingin menyimpan?';
      if (confirm(text)) {
...
/* Warna ketika switch aktif */
input:checked+.ios-slider {
    background-color: #4cd964;
}

/* Posisi lingkaran ketika aktif */
...
.rounded-input {
    ...
    font-size: 16px;
    outline: none;
    /* Menghilangkan outline ketika fokus */
...
.save-button {
  width: 100px; /* Panjang tombol */
  height: 30px; /* Tinggi tombol */
  background-color: #28a745; /* Warna hijau */
  color: white; /* Warna teks putih */
  border: none; /* Menghapus border default */
  border-radius: 20px; /* Membuat border menjadi rounded */
  font-size: 10px; /* Ukuran font */
  cursor: pointer; /* Pointer saat hover */
  transition: background-color 0.3s ease; /* Transisi warna saat di-hover */
}
