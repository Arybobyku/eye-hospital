...
import { formsatuan } from './FormData.js';
import { parsesatuan } from './Attachment.js';
var vm, body;
export default {
	...
	methods: {
		...
		aturulang: function () { vm.form = vm.formsatuan(); },
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parsesatuan(vm.form), 'satuan'); },
      ...
      vm.$emit('dialog', text, button, 'formsatuan');
    },
	}
}
</script>