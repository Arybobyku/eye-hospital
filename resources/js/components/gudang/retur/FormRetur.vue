		...
		<div ref="rootmodal" class="modal-content modal-sedang" :class="terminate.show ? 'modal-opened' : 'modal-closed'">
			...
			<div class="modal-body" v-if="form">
				<div class="grid">
					...
					<div class="col-12">
						<Inputed :ref="form.tanggalretur.name" :form="form.tanggalretur"></Inputed>
...
import { formretur } from './FormData.js';
import { parseretur } from './Attachment.js';
...
export default {
	...
	methods: {
		...
		parseretur, formretur, initindexdb, indexdbprocessing, arrpembelian,
		...
		aturulang: function () { vm.form = vm.formretur(); },
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parseretur(vm.form), 'formretur'); },
		...
		setdataform: function (response) {
			...
			vm.form.tanggalretur.value = data.tanggal_retur;
      ...
      vm.$emit('dialog', text, button, 'formretur');
    },
	}
}
</script>