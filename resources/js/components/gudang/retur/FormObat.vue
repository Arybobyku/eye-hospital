							...
							<div class="col-12">
								<table class="table form-mb" style="border: none">
									<tbody>
										<tr>
											<td>Nama Supplier</td>
											<td style="margin-bottom: 10px;"><strong>{{ form.detailretur.nama_supplier }}</strong></td>
										</tr>
										<tr>
											<td>Kode Retur</td>
											<td style="margin-bottom: 10px;"><strong>{{ form.detailretur.kode_retur }}</strong></td>
										</tr>
										<tr>
											<td>Tanggal Retur</td>
											<td style="margin-bottom: 10px;"><strong>{{ form.detailretur.tanggal_retur }}</strong></td>
										</tr>
									</tbody>
								</table>
							</div>
...
export default {
	...
	methods: {
		...
		add:function() {
			...
			if (next) {
				let tmp = {
					retur_uuid: vm.form.detailretur.uuid,
					kode_retur: vm.form.detailretur.kode_retur,
					supplier_uuid: vm.form.detailretur.supplier_uuid,
					nama_supplier: vm.form.detailretur.nama_supplier,
					tanggal_retur: vm.form.detailretur.tanggal_retur,
		...
		setdataform: function (response) {
			vm.form.detailretur = response.data.data;
			vm.listdata = response.data.dataobat;
			if (vm.form.detailretur.status == 'approve') { vm.isapproval = true; }
