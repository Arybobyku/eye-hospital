...
import { formlayanan } from './FormData.js';
import { parselayanan } from './Attachment.js';
var vm, body;
export default {
	...
	methods: {
		...
		aturulang: function () { vm.form = vm.formlayanan(); },
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parselayanan(vm.form), 'layanan'); },
      ...
      vm.$emit('dialog', text, button, 'formlayanan');
    },
	}
}
</script>