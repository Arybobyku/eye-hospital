...
<FormLayanan ref="FormLayanan" @dialog="dialog" @parsingForm="parsingForm"></FormLayanan>
</template>
...
export default {
	...
	components: { toast, Swal, 
		FormLayanan: defineAsyncComponent(() => import('./FormLayanan.vue')),
	...
	data: function () { return {
		...
		attach: {
			link : {
				list: '/finance/layanan/list',
				add: '/finance/layanan/add',
				edit: '/finance/layanan/edit',
				update: '/finance/layanan/update',
				remove: '/finance/layanan/remove',
			}, url: '', data: null
		},
		column: [
			{ value: 'nama', label: 'Nama Layanan', type: 'text', search: true, close: false, button: false },
