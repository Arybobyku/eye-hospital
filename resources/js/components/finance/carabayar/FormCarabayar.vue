...
import { formcarabayar } from './FormData.js';
import { parsecarabayar } from './Attachment.js';
var vm, body;
export default {
	...
	methods: {
		...
		aturulang: function () { vm.form = vm.formcarabayar(); },
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parsecarabayar(vm.form), 'carabayar'); },
      ...
      vm.$emit('dialog', text, button, 'formcarabayar');
    },
	}
}
</script>