export const formnomor = () => {
	return {
		...
		nomor:{
			title: 'Nomor Kwitansi', for_id: 'form_'+'nomor', type: 'text', required: 'required', 
			name: 'nomor', value: '', disabled: false, show: true, kinds: ''
		},
		diskon:{
			title: 'Diskon ke Asuransi (%) (Opsional)', for_id: 'form_'+'diskon', type: 'number', required: '', 
			name: 'diskon', value: '0', disabled: false, show: true, kinds: ''
		},
	}
}
