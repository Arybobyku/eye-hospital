...
export default {
	...
	data: function () { return {
		...
		attach: {
			link : {
				list: '/rawatjalan/historipemeriksaan/list',
				add: '/rawatjalan/historipemeriksaan/add',
				detail: '/rawatjalan/historipemeriksaan/detail',
				histori: '/rawatjalan/historipemeriksaan/histori',
			}, url: '', data: null
		},
		column: [
