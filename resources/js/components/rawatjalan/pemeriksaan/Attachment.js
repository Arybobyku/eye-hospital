export const parsekelurahan = (form, detail) => {
	...
	data.append('ocular_dextra_autoref_s', form.select.oculardextraautoref_s.value);
	data.append('ocular_dextra_autoref_c', form.select.oculardextraautoref_c.value);
	data.append('ocular_dextra_autoref_x', form.select.oculardextraautoref_x.value);
	...
	data.append('ocular_sinistra_autoref_x', form.select.ocularsinistraautoref_x.value);
	data.append('ocular_sinistra_autoref_c', form.select.ocularsinistraautoref_c.value);
