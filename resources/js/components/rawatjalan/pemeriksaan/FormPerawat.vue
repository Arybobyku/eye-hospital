...
export default {
	...
	data:function() { return { 
		...
		tab: {
			...
			content: { pemeriksaan_fisik: true, skrinning: false, riwayat_kesehatan: false,}
		},
	}},
	methods: {
		...
		show:function(posisi, title, uuid){ vm.btnlbl = posisi == 'adddataperawat' ? 'Save Data' : 'Update Data'; vm.form.uuid = uuid;
		...
		parsingForm:function() { vm.$emit('parsingForm', vm.parsekelurahan(vm.form, vm.detail), 'addperawat'); },
