...
export default {
	...
	data: function () { return {
		...
		attach: {
			link : {
				list: '/rawatjalan/pasienkontrol/list',
				add: '/rawatjalan/pasienkontrol/add',
				detail: '/rawatjalan/pasienkontrol/detail',
			}, url: '', data: null
		},
		column: [
			...
			{ value: 'sudah_diperiksa', label: 'Sudah Dilakukan Pemeriksaan', type: 'text', search: false, close: false, button: false },
