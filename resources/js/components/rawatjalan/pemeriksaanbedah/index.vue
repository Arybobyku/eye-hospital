...
export default {
	...
	data: function () { return {
		...
		attach: {
			link : {
				list: '/rawatjalan/pemeriksaanbedah/list',
				add: '/rawatjalan/pemeriksaanbedah/add',
				detail: '/rawatjalan/pemeriksaanbedah/detail',
				histori: '/rawatjalan/pemeriksaanbedah/histori',
				// call: '/rawatjalan/pemeriksaanbedah/call',
			}, url: '', data: null
		},
		column: [
