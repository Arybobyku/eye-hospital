...
export default {
	...
	data: function () { return {
		...
		attach: {
			link : {
				list: '/rawatjalan/reqopname/list',
				minta: '/rawatjalan/reqopname/minta',
				detail: '/rawatjalan/reqopname/detail',
				batal: '/rawatjalan/reqopname/batal',
				terima: '/rawatjalan/reqopname/terima',
			}, url: '', data: null
		},
		column: [
