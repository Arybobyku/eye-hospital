...
export default {
	...
	data: function () { return {
		...
		tab: {
			...
			content: { pasien: true, antrian: false, pending: false }
		},
		...
		*************************************************************************************************************************/
		...
		btnhtml:function(_item, _index) {
			let str = [
				...
				{ icon: 'book-open', color: 'btn-info', posisi: 'registrasi', tooltip: 'Data Registrasi', item: _item, index: _index, show: true },
		...
		converter: function (data, index, column, identity) {
			let _tmp = '';
			if (identity == 'btnhtml') { _tmp = { value: vm.btnhtml(data, index), ishtml: 'button', style: 'width: 200px' } }
		...
		converterantrian: function (data, index, column, identity) {
			let _tmp = '';
			if (identity == 'btnhtmlantrian') { _tmp = { value: vm.btnhtmlantrian(data, index), ishtml: 'button', style: 'width: 160px' } }
