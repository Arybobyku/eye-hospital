...
export default {
	...
	data: function () { return {
		...
		attach: {
			link : {
				list: '/customerservices/inapbedah/list',
				add: '/customerservices/inapbedah/add',
				edit: '/customerservices/inapbedah/edit',
				update: '/customerservices/inapbedah/update',
				approve: '/customerservices/inapbedah/approve',
				diterima: '/customerservices/inapbedah/diterima',
				dikirim: '/customerservices/inapbedah/dikirim',
				detail: '/customerservices/inapbedah/detail',
			}, url: '', data: null
		},
		column: [
