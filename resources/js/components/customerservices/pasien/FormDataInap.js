...
export const formrawatjalan = () => {
	return {
		...
		nopendaftaran: { 
			title: 'Nomor Antrian', for_id: 'form_'+'nopendaftaran', type: 'text', required: '', 
		...
		select: {
			...
			berkebutuhankhusus: { 
				...
				filter: [], data: [], search: '', option: 'display: none', statics: true,
				class: 'berkebutuhankhusus', isrequired: false, html: 'Berkebutuhan Khusus/Triase/Disabilitas?', issearch: false, disabled: false,
			},
