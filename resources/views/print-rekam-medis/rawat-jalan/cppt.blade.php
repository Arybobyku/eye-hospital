...
<body>
    ...
    @foreach ($registrasi as $dataRegistrasi)
        @foreach ($cppt as $item)
            @if ($dataRegistrasi->uuid == $item->registrasi_uuid && $item->sebagai == 'PERAWAT')   
                ...
                <br>
            @endif
            @if ($dataRegistrasi->uuid == $item->registrasi_uuid && $item->sebagai == 'RO')   
            <table style="border-collapse:collapse; width:400px">
                <tr style="border-collapse:collapse; border:1px solid #767171; width:100px;">
                    <td style="width:150px; padding:5px;">Nama Pemeriksa</td>
                    <td>: {{ $item->pengguna->nama ?? "" }}</td>
            ...
            <br>
             @endif
             @if ($dataRegistrasi->uuid == $item->registrasi_uuid && $item->sebagai == 'DOKTER')   
             <table style="border-collapse:collapse; width:400px">
                 <tr style="border-collapse:collapse; border:1px solid #767171; width:100px;">
                     <td style="width:150px; padding:5px;">Nama Pemeriksa</td>
                     <td>: {{ $item->pengguna->nama ?? "" }}</td>
