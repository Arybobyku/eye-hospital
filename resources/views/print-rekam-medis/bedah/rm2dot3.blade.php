...
<body>
    ...
    <div class="smallfont">
        <table class="tablee2" cellpadding="5" style="width: 100%; ">
            <tr>
                <td class="td1x">Dokter Bedah :</td>
                <td class="td2x">Perawat Scrub :</td>
            ...
            <tr>
                <td class="td1x">Dokter Anastesi</td>
                <td class="td2x">Diagnosis Pra Bedah </td>
            </tr>
            <tr>
                <td class="td1x">Tindakan Operasi</td>
                <td class="td2x">Diagnosis Pasca Bedah </td>
            </tr>
        </table>
        <table class="tablee2" width="100%" cellpadding="2">
            ...
            <tr>
                ...
                <td style="border-top: 1px solid black;"><input type="checkbox" checked></td>
            ...
            <tr>
                ...
                <td style="border-top: 1px solid black;"><input type="checkbox" checked></td>
                <td style="border-top: 1px solid black;" class="td4">Vicry 8-0 </td>
            </tr>
            <tr>
                <td class="td1" style="border-top: 1px solid black;">Cairan Viskoelastik</td>
                <td style="border-top: 1px solid black;"><input type="checkbox" checked></td>
