...
<div class="wrap">
    ...
    <table style="width: 100%;  border: 1px solid black;" cellpadding="0" cellspacing="0" >
        ...
        <tr>
            <td style="padding-bottom: 30px; padding-left: 8px;">Diagnose Medis :</td>
        </tr>
        <tr>
            <td style ="padding-left: 2px;">1. Risiko malnutrisi berdasarkan hasil skrining gizi oleh perawat, kondisi pasien termasuk kategori :</td>
        </tr>
        <tr>
            <td>
                <table>
        ...
        <tr>
            <td>
                <table style="width: 80%;">
                    <tr>
                        <td style="width: 1%; padding-left: 15px;"><input type="checkbox"></td>
            ...
            <td>
                <table style="width: 80%;">
                    <tr>
                        ...
                        <td style="width: 1%; padding-top: 20px;"><input type="checkbox"></td>
            ...
            <td>
                <table style="width: 80%;">
                    <tr>
                        ...
                        <td style="width: 1%; padding-top: 20px;"><input type="checkbox"></td>
                        <td style="width: 49%; padding-top: 20px;">Perluh asuhan gizi (lanjutkan ke Asesmen gizi) </td>
                        <td style="width: 1%;"></td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="padding-bottom: 60px; padding-top: 20px; padding-left: 5px;">6. Kesimpulan : </td>
        </tr>
        <tr>
            <td style="text-align: right; padding-right: 2%;">Tgl :……………………jam : ………………WIB</td>
        </tr>
        <tr>
            <th style="text-align: right; padding-right: 20%; padding-bottom: 80px;">Ahli Gizi,</th>
        </tr>
        <tr>
            <td style="text-align: right; padding-right: 2%;">.........................................................................</td>
        </tr>
        <tr>
            <td style="text-align: right; padding-right: 14%; padding-bottom: 50px;"><i>Nama & Tanda Tangan</i></td>
        </tr>
    </table>
</div>
</body>
