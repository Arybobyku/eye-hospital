...
<body>
    ...
    <div class="wrap">
        ...
        {{$formData->no_surat ?? 'RM 9.5/SPPR/' . config('app.tahun_akreditasi', '22') }}
        </div>
        <table style="">
            {{-- HEADER --}}
            <tr style="">
        ...
        <table style="width: 100%; margin-top: 20px" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td> {{ $data->pernyataan_jenis_kelamin }} </td>
                <br>
            </tr>
            ...
            <tr>
                ...
                <td style="width: 10px"> : </td>
                <td> {{ $data->pernyataan_tempat_tanggal_lahir }} </td>
                <br>
            </tr>
        </table>
        ...
        <div style="font-size: 12pt">
            Pasien diatas dinyatakan batal melakukan operasi yang dijadwalkan pada tanggal
            ({{ \Carbon\Carbon::parse($data->tanggal_operasi)->locale('id')->isoFormat('D MMMM YYYY') }}) dikarenakan
            {{ $data->alasan_batal_operasi }}. Saran dari Dokter {{ $data->saran_dokter }}. Namun pasien
            menolak {{ $data->jawaban_pasien }}.
            <br>
            <br>
        ...
        <div class="right">Medan,
            {{ \Carbon\Carbon::parse($data->tanggal_surat)->locale('id')->isoFormat('D MMMM YYYY') }}
            <br>
            Dokter Pemeriksa
            <br>
            <br>
            <img src="{{ $data->ttd_saksi }}" alt="Base64 Image" width="200px">
            <br>
            <br>
            ({{ $data->nama_saksi }})
        </div>
