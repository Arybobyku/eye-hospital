...
<head>
    ...
    <title>REKAM MEDIS GENERAL - Form Laser prp</title>
    <style>
    @page { margin: 18px; }
    body { margin: 18px; }
        .wrap {
...
<div class="wrap">
	...
	<table style="width: 100%; margin-top: 20px" cellpadding="0" cellspacing="0">
		<tr>
			<td style="width: 100%; font-size: 12pt; line-height: 22px; padding-top: 5px; text-align: justify">Diagnosa: ________________________________________________ <br>
		</tr>
