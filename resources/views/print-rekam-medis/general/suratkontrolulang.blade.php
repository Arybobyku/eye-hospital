...
<head>
  ...
  .line {
    display: inline-block;
    width: 95%;
    border-bottom: 2px dotted black; /* garis di bawah */
    vertical-align: middle;
    padding-top: 19px; /* tambah jarak antara teks dan garis */
}
...
<div class="wrap">
    ...
    <table style="width: 100%;  border-right: 1px solid black; border-left: 1px solid black; border-bottom: 1px solid black;" cellpadding="0" cellspacing="0" >
        <tr>
            ...
            <td style="width: 70%; padding-top: 20px;">: <span class="line"></span></td>
        </tr>
        <tr>
            <td style="width: 30%; padding-left: 20px;">Tempat Tanggal Lahir</td>
            <td style="width: 70%;">: <span class="line"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 70%; padding-top: 20px;">: <span class="line"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" style="width: 100%;  padding-left: 20px; padding-top: 10px;">2. Kontrol lebih lanjut</td>
        </tr>
        <tr>
            <td colspan="2" style="width: 100%;  padding-left: 37px;">1) &nbsp; Kontrol ulang di Rumah Sakit Khusus Mata Prima Vision Medan </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" style="width: 100%;  padding-left: 37px;">2) &nbsp; Kontrol di Fasilitas Kesehatan Tingkat Pertama </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" style="padding-top: 30px;">
                <table style="border: 1px solid black; margin-left: auto; margin-right: 0; padding: 5px;" cellpadding="5" cellspacing="0">
                    <tr>
                        <td style="text-align: center; border-bottom: 1px solid black;">Medan, ................</td>
                    </tr>
                    <tr>
                        <td style="text-align: center; border-bottom: 1px solid black;">DPJP</td>
                    </tr>
                    <tr>
                        <td style="text-align: center; padding-top: 50px;">.................................................</td>
                    </tr>
                    <tr>
