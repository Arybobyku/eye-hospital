	...
	<table  style="width: 100%;  margin-top: -10px; border: none;" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td style="border: none; padding: 2px 5px">: 
				...
				@if ($registrasi->panjar != '0')
					<?php $grandtotaltop = $grandtotaltop - $registrasi->panjar; ?>
				@endif
				@if ($registrasi->cover_asuransi != '0')
					<?php $grandtotaltop = $grandtotaltop - $registrasi->cover_asuransi; ?>
				@endif
		...
		<tr>
			...
			<td style="border: none; padding: 2px 5px">: 
				...
				?>
				RG{{ $registrasi->nomor }}/{{ $tgl }} {{ $bln }} {{ $thn }}
			</td>
		</tr>
	</table>
		...
		<tbody>
			...
			@foreach ($layananpasien as $item)
				<tr>
					...
					<td align="left" style="padding: 5px 7px; width: 65%">
			...
			@if ($registrasi->panjar != '0' || $registrasi->cover_asuransi != '0')
				@if ($registrasi->panjar != '0')
					...
					<tr>
						<td colspan="2" align="left" style="padding: 7px; width: 65%">Biaya Panjar</td>
				...
				@if ($registrasi->cover_asuransi != '0')
					...
					<tr>
						<td colspan="2" align="left" style="padding: 7px; width: 65%">Nominal Asuransi</td>
						<td align="right" style="padding: 7px"><b>Rp. {{ number_format($registrasi->cover_asuransi) }}</b></td>
					</tr>
				@endif
				<tr>
					<td colspan="2" align="left" style="padding: 7px; width: 65%">Grand Total</td>
