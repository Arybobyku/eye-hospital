        ...
        <tr>
            <td style="width: 58%">
                <table class="header-top">
                    ...
                    <tr>
                        <td>Nama</td>
                        <td>: {{ $pasien->sebutan }} <span style="text-transform: uppercase">{{ $pasien->nama }}</span>
                        </td>
                    </tr>
                    <tr>
                ...
                @foreach ($collection as $item)
                    ...
                    @foreach ($item->data as $row)
                        ...
                        <tr>
                            ...
                            <td align="center" style="padding: 10px 2px; width: 17%" valign="top">
                                {{ ubahDate($row->created_at) }}</td>
                            <td align="center" style="padding: 10px 2px" valign="top">
                                {{ number_format($row->tarif) }}</td>
                            <td align="center" style="padding: 10px 2px" valign="top">{{ $row->qty }}</td>
                            <td align="center" style="padding: 10px 2px" valign="top">
                                {{ number_format($row->diskon_rp) }}</td>
                            <td align="center" style="padding: 10px 2px" valign="top">{{ $row->diskon_persen }}
                            </td>
                            <td align="right" style="padding: 10px 2px;" valign="top">
    ...
    ?>
                ...
                @foreach ($resepracikan as $item)
                    ...
                    @foreach ($informasi as $itemin)
                        <tr>
                            ...
                            <td align="center" style="padding: 10px 2px">{{ number_format($itemin->hja_resep) }}
                            </td>
            ...
            @if ($registrasi->panjar != '0' || $registrasi->cover_asuransi != '0')
                ...
                @if ($registrasi->panjar != '0')
                    ...
                    <tr>
                        <td colspan="6" align="left" style="padding: 6px 5px; width: 65%"><b>Biaya Panjar</b>
                        </td>
                        <td colspan="2" align="right" style="padding: 6px 5px"><b>Rp.
                ...
                @if ($registrasi->cover_asuransi != '0')
                    ...
                    <tr>
                        <td colspan="6" align="left" style="padding: 6px 5px; width: 65%"><b>Nominal
                                Asuransi</b></td>
                        <td colspan="2" align="right" style="padding: 6px 5px"><b>Rp.
            ...
            <tr>
                ...
                <td style="width: 37%; font-size: 10pt" colspan="4" align="center">
                    ...
                    <br /><br /><br /><br /><br />
                    <span
                        style="text-decoration: underline; font-size: 10pt"><b>{{ \Crypt::decrypt(\Cookie::get(env('APP_IDENTIFIER') . 'Nama')) }}</b></span>
                </td>
            </tr>
            <tr>
                <td colspan="8" style="font-size: 10pt">*) Harga obat dan alat kesehatan diatas sudah termasuk PPN
                    11%</td>
            </tr>
        </tbody>
    </table>
