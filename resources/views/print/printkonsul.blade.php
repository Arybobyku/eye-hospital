...
<div class="wrap">
	...
	<table style="width: 100%; margin-top: 10px" cellpadding="0" cellspacing="0">
		<tr>
			<td style="width: 65%">
				<span style="text-decoration: underline"><b>SURAT KONSUL</b></span><br />
				<span><b>REFERAL LETTER</b></span>
			</td>
	...
	<table style="width: 100%; margin-top: 16px" cellpadding="0" cellspacing="0">
		<tr>
			<td style="width: 100%; font-size: 12pt; line-height: 22px;">Bersama ini kami konsulkan pasien :</td>
		</tr>
		<tr>
			<td style="width: 100%; font-size: 12pt; line-height: 22px;">Herewith, we would like to refer following patient :</td>
		</tr>
	</table>
	...
	<table style="width: 100%; margin-top: 16px" cellpadding="0" cellspacing="0">
		<tr>
			<td style="width: 100%; padding-top: 2px; font-size: 12pt; line-height: 22px;">Atas bantuannya, kami ucapkan banyak terima kasih.</td>
		</tr>
		<tr>
			<td style="width: 100%; padding-top: 2px; font-size: 12pt; line-height: 22px;">Realy appreciate for your assistance. Thank you in advance and we are looking forward to receiving your report.</td>
		</tr>
	</table>
