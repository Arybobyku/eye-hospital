	...
	<table  style="width: 100%;  margin-top: 10px; border: none;" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td style="border: none; padding: 2px 5px">: 
				<i><b>"{{ terbilang($grandtotaltop) }} Rupiah"</b></i>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" style="border: none; padding: 8px 5px">Biaya Tindakan Perawatan , dan Obat-obatan pasien a.n <b>{{ $pasien->sebutan }} {{ ucwords(strtolower($registrasi->nama_pasien)) }}</b>
				dirawat pada tanggal {{ tglse($registrasi->tanggal) }} di Rumah Sakit Khusus Mata Prima Vision.
			</td>
		</tr>
