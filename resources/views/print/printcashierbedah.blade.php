	...
	<table  style="width: 100%;  margin-top: -10px; border: none;" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td style="border: none; padding: 2px 5px">: 
				...
				?>
				RI{{ $registrasi->no_invoice }}/{{ $tgl }} {{ $bln }} {{ $thn }}
			</td>
		</tr>
	</table>
		...
		<tbody>
			...
			@else
				<tr>
					<td align="center" style="padding: 5px 7px; width: 5%" valign="center"></td>
					<td align="left" style="padding: 5px 7px;">Biaya Administrasi</td>
					<td align="right" style="padding: 5px 7px;">0</td>
				</tr>
				<?php $nomor++; ?>
			...
			@if(count($rawatjalan) > 0)
				@foreach ($rawatjalan as $item)
					<tr>
						...
						<td align="right" style="padding: 5px 7px;">{{ number_format($item->total_total) }}</td>
					</tr>
					<?php $nomor++; ?>
			...
			@if(count($honor) > 0)
				<tr>
					<td colspan="3" style="padding: 10px 8px"><b>Honor Konsultasi Dokter</b></td>
				</tr>
			...
			@else
				...
				<tr>
					<td align="center" style="padding: 5px 7px; width: 5%"></td>
					<td align="left" style="padding: 5px 7px;">Honor Konsultasi Dokter</td>
					<td align="right" style="padding: 5px 7px;">0</td>
				</tr>
				<?php $nomor++; ?>
			...
			@if ($registrasi->panjar == '0' && $registrasi->cover_asuransi == '0')
				<tr>
					...
					<td align="right" style="padding: 4px 7px;"><b>Rp. {{ number_format($grandtotaltop) }}</b></td>
				</tr>
			@endif
			...
			@if ($registrasi->panjar != '0' || $registrasi->cover_asuransi != '0')
				...
				<tr>
					...
					<td align="right" style="padding: 7px"><b>Rp. {{ number_format($grandtotaltop) }}</b></td>
				</tr>
			@endif
			<tr>
				<td colspan="2" align="left" style="padding: 7px; width: 65%"><b>Total Pembayaran</b></td>
				<td align="right" style="padding: 7px"><b>Rp. {{ number_format($grandtotal) }}</b></td>
			</tr>
		</tbody>
	</table>
