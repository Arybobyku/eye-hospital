		...
		<tbody>
			...
			@if ($diskon != 0)
				...
				<tr >
					...
					<td colspan="1" align="right" style="padding: 4px 7px;"><b>Rp. {{ number_format($diskon) }}</b></td>
				</tr>
			@endif
			@if ($diskonGlobal != 0)

				<tr >
					<td colspan="2" align="left" style="padding: 4px 7px; width: 65%;"><b>Diskon Global</b></td>
					<td colspan="1" align="right" style="padding: 4px 7px;"><b>Rp. {{ number_format($diskonGlobal) }}</b></td>
				</tr>
			@endif
				<tr >
					<td colspan="2" align="left" style="padding: 4px 7px; width: 65%;"><b>Total Diskon</b></td>
					
					<td colspan="1" align="right" style="padding: 4px 7px;"><b>Rp. {{ number_format($totalDiskonGlobal) }}</b></td>
				</tr>
				<tr >
					<td colspan="2" align="left" style="padding: 4px 7px; width: 65%;"><b>Total Pembayaran</b></td>
					<td colspan="1" align="right" style="padding: 4px 7px;"><b>Rp. {{ number_format($grandtotal) }}</b></td>
				</tr>
			@endif
