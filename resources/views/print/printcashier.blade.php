    ...
    <div class="wrap">
        <table style="width: 100%; text-align: center" border="0">
            <thead>
                <tr>
                    <th>
                        <img style="width: 100px; position: relative; left: -300px;"
                            src="data:image/png;base64,
					<?php echo base64_encode(file_get_contents($fullpath)); ?>" />
                        <p style="margin-top: -85px; margin-left: -260px">
                            <span style="font-size: 14px; position: relative; left: -10px; top: -3px">RUMAH SAKIT KHUSUS
                                MATA</span><br />
                            <span
                                style="font-size: 35px; position: relative; left: 10px; top: -8px; color: #18365d">PRIMA
                                VISION</span><br />
                            <span style="font-size: 14px; position: relative; left: -10px; top: -13px">VISION FOR THE
                                NATION</span>
                        </p>
                    </th>
                </tr>
                <tr>
                    <th>
                        <div
                            style="width: 83%; font-size: 9.5pt; padding-left: 19%; text-align:left; position: relative; top: -32px">
                            <span style="text-decoration: underline">PRIMA VISION EYE HOSPITAL - 24 HOURS EYE-ACCIDENT
                                AND EMERGENCY UNIT</span><br />
                            <span style="text-transform: uppercase;">Jalan Pabrik Tenun No. 51-53. Medan Petisah. 20118.
     ...
     ?>
            ...
            <tr>
                ...
                <td style="border: none; padding: 2px 5px; text-transform: uppercase;">: {{ $pasien->sebutan }}
                    {{ $registrasi->nama_pasien }}</td>
            </tr>
            <tr>
			...
			@endforeach --}}
                ...
                @if (count($honor) > 0)
                    ...
                    @if (count($honorbedah) < 1)
                        <tr style="border-bottom: 1px solid #343224">
                            <td style="padding: 5px 7px; font-weight: bold;" colspan="2">Sub Total</td>
                            <td align="right" style="padding: 5px 7px; font-weight: bold;">
                ...
                @if (count($honorbedah) > 0)
                    ...
                    <tr style="border-bottom: 1px solid #343224">
                        <td style="padding: 5px 7px; font-weight: bold;" colspan="2">Sub Total</td>
                        <td align="right" style="padding: 5px 7px; font-weight: bold;">
                            {{ number_format($subtotalBedah + $subtotal) }}</td>
                    </tr>
                ...
                @if ($registrasi->panjar == '0' && $registrasi->cover_asuransi == '0')
                    ...
                    <tr>
                        ...
                        <td align="right" style="padding: 4px 7px;"><b>Rp. {{ number_format($grandtotaltemp) }}</b>
                        </td>
                    </tr>
                @endif
                ...
                @if ($registrasi->panjar != '0' || $registrasi->cover_asuransi != '0')
                    @if ($registrasi->panjar != '0')
                        ...
                        <tr>
                            <td colspan="2" align="left" style="padding: 7px; width: 65%"><b>Biaya Panjar</b>
                            </td>
                            <td align="right" style="padding: 7px"><b>Rp.
                                    {{ number_format($registrasi->panjar) }}</b></td>
                        </tr>
                    @endif
                    ...
                    @if ($registrasi->cover_asuransi != '0')
                        ...
                        <tr>
                            <td colspan="2" align="left" style="padding: 7px; width: 65%"><b>Nominal
                                    Asuransi</b></td>
                            <td align="right" style="padding: 7px"><b>Rp.
                                    {{ number_format($registrasi->cover_asuransi) }}</b></td>
                        </tr>
                    @endif
                    <?php
                    // $grandtotaltemp = $grandtotaltemp + $diskon
    ...
    ?>
			...
			@endif --}}
                @if ($diskon != 0 || $registrasi->diskon_rp != 0)
                    ...
                    {{-- @if ($diskon != 0)
                        <tr>
                            <td colspan="2" align="left" style="padding: 4px 7px; width: 65%;"><b>Diskon
                                    Item</b></td>
                ...
                @if (
                    ...
                    @if (($registrasi->apakah_paket == 'Ya' || $registrasi->apakah_paket == 'ya') && $registrasi->cover_asuransi != 0)
                        <tr>
                            <td colspan="2" align="left" style="padding: 4px 7px; width: 65%"><b>Dibayarkan
                                    pasien</b></td>
                            <td align="right" style="padding: 4px 7px"><b>Rp. {{ number_format($grandtotal) }}</b>
                            </td>
                        </tr>
