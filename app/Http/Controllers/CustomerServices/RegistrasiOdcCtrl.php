...
class RegistrasiOdcCtrl extends Controller
{
	...
	public function pageodc(Request $request) {
	...
	public function rawatodc(Request $request) {
	...
	public function editrawatodc(Request $request) {
	...
	public function cancelrawatiodc(Request $request) {
