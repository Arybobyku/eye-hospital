...
class PrintKasirInapCtrl extends Controller
{
  ...
  public function print($uuid)
  {
    $pdf = \App::make('dompdf.wrapper');
		...
		$honorbedah = LayananPasien::where('registrasi_uuid', '=', $uuid)->where('jenis', '=', 'Honor Dokter Bedah Mata')
								->select(
									'jenis',
									'nama_dokter',
									DB::raw('sum(tarif) as total_tarif')
    ...
    $pdf->loadView('print.printcashierinap', compact('collection', 'registrasi', 'pasien', 'surat', 'layananpasien',
	...
	public function printrincian($uuid)
  {
    $pdf = \App::make('dompdf.wrapper');
		$registrasi = Registrasi::where('uuid', '=', $uuid)->first();
		$rawatjalan = LayananPasien::where('registrasi_uuid', '=', $uuid)->where('jenis', '=', 'Rawat Inap')
								->select(
									'nama_dokter', 
									'nama_layanan', 
									'tarif',
    ...
    $pdf->loadView('print.printcashierrincianinap', 
