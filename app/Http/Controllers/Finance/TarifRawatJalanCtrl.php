...
class TarifRawatJalanCtrl extends Controller
{
	...
	public function add(Request $request) { 
		...
		try{
			...
			if ($request->uuid != '' && $request->uuid != ' ' && $request->uuid) {
				...
				$item = CaraBayarTindakanRawatJalan::where('uuid', '=', $request->uuid)->update($arr);
			}
			else {
				...
				$item->tindakan_rawat_jalan_uuid = $request->tindakan_uuid;
				$item->nama_tindakan_rawat_jalan = $request->tindakan_nama;
			...
			$item = CaraBayarTindakanRawatJalan::where('carabayar_uuid', '=', $request->carabayar_uuid)->get();
	...
	public function remove(Request $request) { 
		...
		$get = CaraBayarTindakanRawatJalan::where('uuid', '=', $request->uuid)->first();
		...
		try{
			...
			$remove = CaraBayarTindakanRawatJalan::where('uuid', '=', $request->uuid)->delete();
			$item = CaraBayarTindakanRawatJalan::where('carabayar_uuid', '=', $request->carabayar_uuid)->get();
			DB::commit();
