...
class ClaimCtrl extends Controller
{
	...
	public function list(Request $request) {
		...
		if ($request->search != "") {
			$data = Registrasi::where('delete_soft', '=', 1)
								...
								->where('carabayar_uuid', '!=', '1bddd542-fd1e-4b6a-b629-53bd35428796') // Umum
								->where('carabayar_uuid', '!=', 'e3ed042d-2b41-4672-bcc2-7a816a622667') // Bpjs Kesehatan
								->where('carabayar_uuid', '!=', 'd494b806-9af6-4ccc-af2a-50be75e0814f') // Bpjs Ketenagakerjaan
								->where('carabayar_uuid', '!=', '91cf4fa7-f35f-41e2-8e29-0ed6a3982da3') // Socfindo
								->where('carabayar_uuid', '!=', 'f93e2aeb-0f76-4f16-8bc0-b291eb16e740') // Prodia
								->where('carabayar_uuid', '!=', 'b20fdd4c-a0e7-45df-94c7-2877eb82b6d0') // PLN
								->where(function($q) {
