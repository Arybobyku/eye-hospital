...
class ReqOpnameCtrl extends Controller
{
	...
	public function list(Request $request) {
		...
		if ($request->search != "") {
			$data = MintaTerimaOpname::where('delete_soft', '=', 1)
				...
				->where('dari_unit_uuid', '=', '60df3cd5-57c2-4f05-b5fa-dffba34400dc')
	...
	public function minta(Request $request) {
		...
		if ($request->kode == '') {
			...
			PenggunaHelp::log('(Rawat Jalan) Melakukan request/permintaan data obat/alkes ke gudang farmasi sebanyak '.count($permintaan).' item obat/alkes dengan kode '.$kode);
		}
		else {
			...
			PenggunaHelp::log('(Rawat Jalan) Melakukan perubahan request/permintaan data obat/alkes ke gudang farmasi sebanyak '.count($permintaan).' item obat/alkes dengan kode '.$kode);
		}
