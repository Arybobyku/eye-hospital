	...
	public function list(Request $request) {
		...
		if ($request->search != "") {
			$data = MintaTerimaOpname::where('delete_soft', '=', 1)
				...
				->where('dari_unit_uuid', '=', 'c7887937-6e20-45dd-b437-f0ee6dccc1fa')
		...
		try{
			...
			foreach($msg as $row) {
				...
				if ($stockopname) {
					...
					$stockopname->unit_uuid = 'c7887937-6e20-45dd-b437-f0ee6dccc1fa';
					$stockopname->nama_unit = 'Bedah / Operasi';
					$stockopname->save();
				}
			}
