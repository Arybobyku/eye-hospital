...
class StockOpnameGudang implements FromView, ShouldAutoSize
{
	private $dari = '';
  ...
  public function view(): View
  {
		...
		$data = DB::table('stock_catat')
									...
									->where('stock_catat.unit_uuid', '=', 'bc0582ff-ce98-45f4-b361-ecef5b686a0f')
    ...
    return view('exports.stockopnamegudang', [ 'data' => $data, 'bulan' => $nama_bulan, 'tahun' => $tahun  ]);
  }
}