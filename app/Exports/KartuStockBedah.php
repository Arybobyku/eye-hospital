...
class KartuStockBedah implements FromView, ShouldAutoSize
{
	...
	public function view(): View
	{
		  ...
		  ->where(function($query) {
			  $query->where('ke_unit_uuid', '=', 'c7887937-6e20-45dd-b437-f0ee6dccc1fa')
					->orWhere('dari_unit_uuid', '=', 'c7887937-6e20-45dd-b437-f0ee6dccc1fa');
		  })
		  ->where('delete_soft', 1)
	  ...
	  $resepQuery = DB::table('resep')
		  ->select(
			  ...
			  DB::raw("'Bedah/Operasi' as dari_nama_unit"),
	  ...
	  return view('exports.kartustockbedah', [ 'data' => $allTransactions, 'dari' => $this->dari, 'ke' => $this->ke  ]);
	}
  }