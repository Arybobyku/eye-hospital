...
class FakturGudang implements FromView, ShouldAutoSize
{
	private $dari = '';
	private $ke = '';
  ...
  public function view(): View
  {
		$data = DB::table('pembelian_detail')
									->whereBetween('tanggal_faktur', [$this->dari, $this->ke])
		...
		$data = $data->get();
    return view('exports.fakturgudang', [ 'data' => $data, 'nama_supplier' => $nama_supplier, 'ke' => $this->ke, 'dari' => $this->dari ]);
  }
}