...
class StockOpnameBedah implements FromView, ShouldAutoSize
{
	private $dari = '';
  ...
  public function view(): View
  {
		...
		$data = DB::table('stock_catat')
									...
									->where('stock_catat.unit_uuid', '=', 'c7887937-6e20-45dd-b437-f0ee6dccc1fa')
    ...
    return view('exports.stockopnamebedah', [ 'data' => $data, 'bulan' => $nama_bulan, 'tahun' => $tahun  ]);
  }
}