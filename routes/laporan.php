...
Route::group(['middleware' => 'throttle: 250, 1'], function(){
	...
	Route::get('excel/tindakan/{dari}/{ke}/{carabayar_uuid}/{asuransi_uuid}/{dokter_uuid}/{layanan_uuid}/{jenis_registrasi}', [LaporanKeuanganCtrl::class, 'tindakan'])->name('laporan-tindakan');
	Route::get('excel/tindakan-v2/{dari}/{ke}/{carabayar_uuid}/{asuransi_uuid}/{dokter_uuid}/{layanan_uuid}/{jenis_registrasi}', [LaporanKeuanganCtrl::class, 'tindakanv2'])->name('laporan-tindakan');
